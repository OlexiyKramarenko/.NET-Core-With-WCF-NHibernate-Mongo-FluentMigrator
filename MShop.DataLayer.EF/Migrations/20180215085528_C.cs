        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PlainTextBody = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OnlyForMembers = table.Column<bool>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(nullable: false),
                    AddedBy = table.Column<string>(nullable: true),
                    AddedByIP = table.Column<string>(nullable: true),
                    AddedDate = table.Column<DateTime>(nullable: false),
                    Approved = table.Column<bool>(nullable: false),
                    Body = table.Column<string>(nullable: true),
                    Closed = table.Column<bool>(nullable: false),
                    ForumId = table.Column<Guid>(nullable: false),
                    IsThreadPost = table.Column<bool>(nullable: false),
                    LastPostBy = table.Column<string>(nullable: true),
                    LastPostDate = table.Column<DateTime>(nullable: false),
                    ParentPostId = table.Column<Guid>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(nullable: false),
                    AddedBy = table.Column<string>(nullable: true),
                    AddedByEmail = table.Column<string>(nullable: true),
                    AddedByIp = table.Column<string>(nullable: true),
                    AddedDate = table.Column<DateTime>(nullable: false),
